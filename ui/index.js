...
var css$b = ".styles_module_componentWrap__62495026 {\n  position: relative;\n  justify-content: flex-end;\n  display: flex;\n  flex-direction: column;\n}\n\n.styles_module_inputWrap__62495026 {\n  position: relative;\n  justify-content: flex-end;\n  display: flex;\n  flex-direction: column;\n}\n\n.styles_module_label__62495026 {\n  opacity: 0.3;\n  margin-bottom: 5px;\n}\n\n.styles_module_moneySign__62495026 {\n  font-family: \"ABCMarfa\", sans-serif;\n  font-weight: 200;\n  font-size: 40px;\n  line-height: 40px;\n  pointer-events: none;\n  position: absolute;\n  bottom: 14px;\n}\n\n.styles_module_input__62495026 {\n  font-family: \"ABCMarfa\", sans-serif;\n  font-weight: 200;\n  font-size: 40px;\n  line-height: 40px;\n  padding: 10px 8px;\n  height: 68px;\n  background: none;\n  border: none;\n  outline: none;\n  margin-left: -8px;\n  width: calc(100% + 8px);\n  border-radius: 5px;\n  transition: background-color 0.15s ease;\n}\n.styles_module_input__62495026::-moz-placeholder {\n  color: var(--color-main-transparent-80);\n}\n.styles_module_input__62495026:-ms-input-placeholder {\n  color: var(--color-main-transparent-80);\n}\n.styles_module_input__62495026::placeholder {\n  color: var(--color-main-transparent-80);\n}\n.styles_module_input__62495026:focus-visible {\n  background-color: rgba(0, 0, 0, 0.035);\n}\n\n.styles_module_helperText__62495026 {\n  color: var(--color-main-transparent-200);\n  margin-top: 10px;\n  line-height: 120%;\n}\n\n.styles_module_money__62495026 .styles_module_input__62495026 {\n  padding-left: 45px;\n}\n\n.styles_module_error__62495026 .styles_module_helperText__62495026 {\n  color: var(--color-service-error-main);\n}\n.styles_module_error__62495026 .styles_module_input__62495026 {\n  background-color: rgba(255, 68, 85, 0.09);\n}\n\n.styles_module_shake__62495026 {\n  -webkit-animation-name: styles_module_shakeAnimation__62495026;\n  animation-name: styles_module_shakeAnimation__62495026;\n  -webkit-animation-duration: 0.4s;\n  animation-duration: 0.4s;\n  -webkit-animation-iteration-count: 1;\n  animation-iteration-count: 1;\n  -webkit-animation-timing-function: ease;\n  animation-timing-function: ease;\n}\n\n@-webkit-keyframes styles_module_shakeAnimation__62495026 {\n  0% {\n    transform: translateX(0);\n  }\n  30% {\n    transform: translateX(-10px);\n  }\n  40% {\n    transform: translateX(10px);\n  }\n  60% {\n    transform: translateX(-10px);\n  }\n  100% {\n    transform: translateX(0);\n  }\n}\n\n@keyframes styles_module_shakeAnimation__62495026 {\n  0% {\n    transform: translateX(0);\n  }\n  30% {\n    transform: translateX(-10px);\n  }\n  40% {\n    transform: translateX(10px);\n  }\n  60% {\n    transform: translateX(-10px);\n  }\n  100% {\n    transform: translateX(0);\n  }\n}";
var modules_efc4e723$b = {"componentWrap":"styles_module_componentWrap__62495026","inputWrap":"styles_module_inputWrap__62495026","label":"styles_module_label__62495026","moneySign":"styles_module_moneySign__62495026","input":"styles_module_input__62495026","helperText":"styles_module_helperText__62495026","money":"styles_module_money__62495026","error":"styles_module_error__62495026","shake":"styles_module_shake__62495026","shake-animation":"styles_module_shakeAnimation__62495026"};
n(css$b,{});
...
var ChipsSlider = function (props) {
    ...
    var _d = React__default["default"].useState(true), onThrowComplete = _d[0], setOnThrowComplete = _d[1];
    ...
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$8.sliderContainer, " ").concat(props.containerClassName), ref: sliderContainerRef, tabIndex: 0, onFocus: function () {
        ...
        React__default["default"].createElement(ArrowButton, { ref: arrowLeftRef, className: "".concat(modules_efc4e723$8.arrowLeft, " ").concat(modules_efc4e723$8.arrowButton, " ").concat(props.arrowsClassName), direction: "left", onMouseUp: goPreviousCard, disabled: activeIndex === 0, style: {
                pointerEvents: isArrowButtonDisabled ? "none" : "auto",
            } }),
        React__default["default"].createElement(ArrowButton, { ref: arrowRightRef, className: "".concat(modules_efc4e723$8.rightArrow, " ").concat(modules_efc4e723$8.arrowButton, " ").concat(props.arrowsClassName), direction: "right", onMouseUp: goToNextCard, disabled: activeIndex === props.items.length - 1, style: {
                pointerEvents: isArrowButtonDisabled ? "none" : "auto",
            } }),
        React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$8.sliderWrap), ref: sliderViewRef },
            ...
            React__default["default"].createElement("div", { className: modules_efc4e723$8.slider, ref: sliderRef, id: "small-cards-slider", onFocus: function () {
                ...
                React__default["default"].createElement("div", { className: modules_efc4e723$8.sliderCards, style: {
                    ...
                    return (React__default["default"].createElement("div", { key: index, className: "".concat(modules_efc4e723$8.itemWrap), ref: function (el) { return (sliderItemWrapRefs.current[index] = el); }, style: {
                            height: "".concat(props.cardHeight + props.spaceBetween, "px"),
                            width: "".concat(props.cardWidth + props.spaceBetween, "px"),
                        } },
                        React__default["default"].createElement("div", { "data-index": index, className: "".concat(modules_efc4e723$8.item), ref: function (el) { return (sliderItemRefs.current[index] = el); }, onClick: function () { return handleCardClick(index); }, style: {
        ...
        props.caption ? (React__default["default"].createElement("div", { className: modules_efc4e723$8.itemCaption },
