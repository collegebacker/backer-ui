...
var css$h = ".styles_module_icon__0f281710 {\n  display: flex;\n  height: 24px;\n  width: 24px;\n}\n.styles_module_icon__0f281710 svg {\n  width: 100%;\n  height: 100%;\n  fill: var(--color-main-500);\n}";
var modules_efc4e723$h = {"icon":"styles_module_icon__0f281710"};
n(css$h,{});
...
var Icon = function (props) {
    return (React__default["default"].createElement("i", { className: "".concat(modules_efc4e723$h.icon, " ").concat(props.className), style: __assign({}, props.style) },
...
var Spinner = function (props) {
    ...
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$f.loaderWrap, " ").concat(props.className), style: __assign(__assign({}, props.style), { width: getSize(props.size), height: getSize(props.size) }) },
        React__default["default"].createElement("svg", { width: getSize(props.size), height: getSize(props.size), viewBox: "0 0 ".concat(getSize(props.size), " ").concat(getSize(props.size)), fill: "none", className: "".concat(modules_efc4e723$f.loader, " ").concat(modules_efc4e723$f[props.size]), style: props.color ? { fill: props.color } : {}, xmlns: "http://www.w3.org/2000/svg" },
            React__default["default"].createElement("circle", { className: modules_efc4e723$f.path, cx: getSize(props.size) / 2, cy: getSize(props.size) / 2, r: getSize(props.size) / 2 - 3 }),
            React__default["default"].createElement("circle", { className: modules_efc4e723$f.backPath, cx: getSize(props.size) / 2, cy: getSize(props.size) / 2, r: getSize(props.size) / 2 - 3 }))));
};
...
var ButtonContent = function (_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        props.label ? (React__default["default"].createElement("span", { className: "".concat(modules_efc4e723$g.text) }, !props.busy ? props.label : props.busyLabel)) : null,
        props.icon && !props.busy ? (React__default["default"].createElement(Icon, { name: props.icon, className: modules_efc4e723$g.icon, style: props.label
                ? {
                    marginLeft: "10px",
                }
                : {} })) : null,
        props.busy ? (React__default["default"].createElement(Spinner, { className: modules_efc4e723$g.spinner, size: "medium-small", style: props.busyLabel && props.label
                ? {
                    marginLeft: "10px",
                }
                : {} })) : null));
...
var Button = React__default["default"].forwardRef(function (props, ref) {
    var classes = "".concat(props.className, " ").concat(modules_efc4e723$g.button, " ").concat(modules_efc4e723$g[props.mode], " ").concat(modules_efc4e723$g[props.size], " ").concat(props.disabled ? modules_efc4e723$g.disabled : "", " ").concat(props.label
        ? modules_efc4e723$g["minWidth-".concat(props.size)]
        : modules_efc4e723$g["fixedSize-".concat(props.size)]);
...
var Input = React__default["default"].forwardRef(function (props, ref) {
    ...
    return (React__default["default"].createElement("div", { ref: ref, className: "".concat(modules_efc4e723$e.componentWrap, " ").concat(props.className, " ").concat(props.isInvalid ? modules_efc4e723$e.error : "", " ").concat(props.isInvalid ? modules_efc4e723$e.shake : "") },
        React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$e.inputWrap), style: {
                height: props.label !== "" ? "68px" : "40px",
            } },
            props.icon ? (React__default["default"].createElement("div", { onClick: props.icon.onClick, className: modules_efc4e723$e.icon, style: {
                    pointerEvents: props.icon.onClick !== undefined ? "auto" : "none",
                } },
                React__default["default"].createElement(Icon, { name: props.icon.name }))) : null,
            React__default["default"].createElement("input", { ref: inputRef, tabIndex: props.tabIndex, autoFocus: props.autoFocus, type: props.type, id: props.id ? props.id : props.name, name: props.name, className: "".concat(modules_efc4e723$e.input, " ").concat(props.hideSpinButton ? modules_efc4e723$e.hideSpinButton : ""), placeholder: "\u00A0", value: val, required: props.required, onChange: handleOnChange, onSubmit: props.onSubmit, onBlur: props.onBlur, onFocus: props.onFocus, onInvalid: props.onInvalid }),
            props.label !== "" ? (React__default["default"].createElement("label", { className: modules_efc4e723$e.label, htmlFor: props.name }, props.label)) : null),
        props.helperText && !props.isInvalid ? (React__default["default"].createElement(Text, { className: modules_efc4e723$e.helperText, tag: "span", context: "app", appStyle: "body-caption" }, props.helperText)) : null,
        props.isInvalid ? (React__default["default"].createElement(Text, { className: modules_efc4e723$e.helperText, tag: "span", context: "app", appStyle: "body-caption" }, props.errorMessage)) : null));
});
...
var css$d = ".styles_module_componentWrap__d0ca078d {\n  position: relative;\n  justify-content: flex-end;\n  display: flex;\n  flex-direction: column;\n}\n\n.styles_module_inputWrap__d0ca078d {\n  position: relative;\n  justify-content: flex-end;\n  display: flex;\n  flex-direction: column;\n}\n\n.styles_module_label__d0ca078d {\n  opacity: 0.3;\n  margin-bottom: 5px;\n}\n\n.styles_module_moneySign__d0ca078d {\n  font-family: \"ABCMarfa\", sans-serif;\n  font-weight: 200;\n  font-size: 40px;\n  line-height: 40px;\n  pointer-events: none;\n  position: absolute;\n  bottom: 14px;\n}\n\n.styles_module_input__d0ca078d {\n  font-family: \"ABCMarfa\", sans-serif;\n  font-weight: 200;\n  font-size: 40px;\n  line-height: 40px;\n  padding: 10px 8px;\n  height: 68px;\n  background: none;\n  border: none;\n  outline: none;\n  margin-left: -8px;\n  width: calc(100% + 8px);\n  border-radius: 5px;\n  transition: background-color 0.15s ease;\n}\n.styles_module_input__d0ca078d::-moz-placeholder {\n  color: var(--color-main-transparent-80);\n}\n.styles_module_input__d0ca078d:-ms-input-placeholder {\n  color: var(--color-main-transparent-80);\n}\n.styles_module_input__d0ca078d::placeholder {\n  color: var(--color-main-transparent-80);\n}\n.styles_module_input__d0ca078d:focus-visible {\n  background-color: rgba(0, 0, 0, 0.035);\n}\n\n.styles_module_helperText__d0ca078d {\n  color: var(--color-main-transparent-200);\n  margin-top: 10px;\n  line-height: 120%;\n}\n\n.styles_module_money__d0ca078d .styles_module_input__d0ca078d {\n  padding-left: 45px;\n}\n\n.styles_module_error__d0ca078d .styles_module_helperText__d0ca078d {\n  color: var(--color-service-error-main);\n}\n.styles_module_error__d0ca078d .styles_module_input__d0ca078d {\n  background-color: rgba(255, 68, 85, 0.06);\n}\n\n.styles_module_shake__d0ca078d {\n  -webkit-animation-name: styles_module_shakeAnimation__d0ca078d;\n  animation-name: styles_module_shakeAnimation__d0ca078d;\n  -webkit-animation-duration: 0.4s;\n  animation-duration: 0.4s;\n  -webkit-animation-iteration-count: 1;\n  animation-iteration-count: 1;\n  -webkit-animation-timing-function: ease;\n  animation-timing-function: ease;\n}\n\n@-webkit-keyframes styles_module_shakeAnimation__d0ca078d {\n  0% {\n    transform: translateX(0);\n  }\n  30% {\n    transform: translateX(-10px);\n  }\n  40% {\n    transform: translateX(10px);\n  }\n  60% {\n    transform: translateX(-10px);\n  }\n  100% {\n    transform: translateX(0);\n  }\n}\n\n@keyframes styles_module_shakeAnimation__d0ca078d {\n  0% {\n    transform: translateX(0);\n  }\n  30% {\n    transform: translateX(-10px);\n  }\n  40% {\n    transform: translateX(10px);\n  }\n  60% {\n    transform: translateX(-10px);\n  }\n  100% {\n    transform: translateX(0);\n  }\n}";
var modules_efc4e723$d = {"componentWrap":"styles_module_componentWrap__d0ca078d","inputWrap":"styles_module_inputWrap__d0ca078d","label":"styles_module_label__d0ca078d","moneySign":"styles_module_moneySign__d0ca078d","input":"styles_module_input__d0ca078d","helperText":"styles_module_helperText__d0ca078d","money":"styles_module_money__d0ca078d","error":"styles_module_error__d0ca078d","shake":"styles_module_shake__d0ca078d","shake-animation":"styles_module_shakeAnimation__d0ca078d"};
n(css$d,{});
...
var GhostInput = React__default["default"].forwardRef(function (props, ref) {
    ...
    return (React__default["default"].createElement("div", { ref: ref, className: "".concat(modules_efc4e723$d.componentWrap, " ").concat(props.className, " ").concat(props.isInvalid ? modules_efc4e723$d.error : "", " ").concat(props.type === "money" ? modules_efc4e723$d.money : "", " ").concat(props.isInvalid ? modules_efc4e723$d.shake : "") },
        React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$d.inputWrap) },
            props.type === "money" ? (React__default["default"].createElement("span", { className: modules_efc4e723$d.moneySign }, props.currency)) : null,
            props.label !== "" ? (React__default["default"].createElement(Text, { tag: "label", className: modules_efc4e723$d.label, htmlFor: props.name, context: "app", appStyle: "body-caption" }, props.label)) : null,
            React__default["default"].createElement("input", { ref: inputRef, tabIndex: props.tabIndex, autoFocus: props.autoFocus, type: props.type, id: props.id ? props.id : props.name, name: props.name, className: "".concat(modules_efc4e723$d.input), placeholder: props.placeholder, value: val, required: props.required, onChange: handleOnChange, onSubmit: props.onSubmit, onBlur: props.onBlur, onFocus: props.onFocus, onInvalid: props.onInvalid })),
        props.helperText && !props.isInvalid ? (React__default["default"].createElement(Text, { className: modules_efc4e723$d.helperText, tag: "span", context: "app", appStyle: "body-caption" }, props.helperText)) : null,
        props.isInvalid ? (React__default["default"].createElement(Text, { className: modules_efc4e723$d.helperText, tag: "span", context: "app", appStyle: "body-caption" }, props.errorMessage)) : null));
});
...
var CodeInput = React__default["default"].forwardRef(function (props, ref) {
    ...
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$c.componentWrap, " ").concat(props.className, " ").concat(props.isInvalid ? modules_efc4e723$c.error : ""), style: props.style },
        React__default["default"].createElement("section", { ref: ref, onPaste: handlePaste, onFocus: handleOnFocus, className: "".concat(props.isInvalid ? modules_efc4e723$c.shake : "") }, Array.from({ length: props.length }).map(function (_, index) {
            return (React__default["default"].createElement("input", { type: "number", pattern: "\\d*", placeholder: "*", key: index, className: modules_efc4e723$c.input, ref: function (input) {
        ...
        props.isInvalid ? (React__default["default"].createElement(Text, { tag: "span", className: modules_efc4e723$c.helperText, context: "app", appStyle: "body-caption" }, props.errorMessage)) : null,
        React__default["default"].createElement(Text, { tag: "p", context: "app", appStyle: "body-main", className: modules_efc4e723$c.resendSection },
            props.resendText,
            " ",
            React__default["default"].createElement("a", { className: "".concat(modules_efc4e723$c.resendLink, " ").concat(resendTimer > 0 ? modules_efc4e723$c.resendLink_disabled : ""), onClick: handleResend }, "Resend code"),
            " ",
...
var Backer = function (props) { return (React__default["default"].createElement("svg", { viewBox: "0 0 170 40", xmlns: "http://www.w3.org/2000/svg", className: "".concat(props.hoverAnimation ? modules_efc4e723$b.hoverAnimation : "") },
    React__default["default"].createElement(BackerSignPath, null),
...
var BackerSign = function (props) { return (React__default["default"].createElement("svg", { viewBox: "0 0 40 40", xmlns: "http://www.w3.org/2000/svg", className: "".concat(props.hoverAnimation ? modules_efc4e723$b.hoverAnimation : "") },
    React__default["default"].createElement(BackerSignPath, null))); };
...
var Logo = React__default["default"].forwardRef(function (props, ref) {
    return (React__default["default"].createElement("div", { ref: ref, className: "".concat(props.className, " ").concat(modules_efc4e723$b.logo) }, renderLogo(props)));
});
...
var css$9 = ".styles_module_sliderContainer__8ff8ce5a {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  opacity: 0;\n}\n.styles_module_sliderContainer__8ff8ce5a:focus-visible {\n  outline: none !important;\n  border: none !important;\n}\n.styles_module_sliderContainer__8ff8ce5a:focus-visible .styles_module_sliderWrap__8ff8ce5a {\n  outline: 2px solid var(--color-accent-transparent-200);\n  outline-offset: 10px;\n  border-radius: 5px;\n}\n\n.styles_module_sliderWrap__8ff8ce5a {\n  z-index: 1;\n  position: relative;\n  width: 100%;\n  outline-offset: 5px;\n  outline-color: var(--color-accent-transparent-200);\n  transition: outline-offset 0.2s ease, outline-color 0.2s ease;\n}\n.styles_module_sliderWrap__8ff8ce5a::-webkit-scrollbar {\n  display: none;\n}\n\n.styles_module_leftGradient__8ff8ce5a,\n.styles_module_rightGradient__8ff8ce5a {\n  pointer-events: none;\n  z-index: 2;\n  content: \"\";\n  position: absolute;\n  top: 0;\n  width: 40px;\n  height: 100%;\n}\n\n.styles_module_leftGradient__8ff8ce5a {\n  left: 0;\n  background: linear-gradient(to right, rgb(255, 255, 255), rgba(255, 255, 255, 0));\n}\n\n.styles_module_rightGradient__8ff8ce5a {\n  right: 0;\n  background: linear-gradient(to left, rgb(255, 255, 255), rgba(255, 255, 255, 0));\n}\n\n.styles_module_slider__8ff8ce5a {\n  width: 100%;\n  padding: 4px 0;\n  position: relative;\n  height: 100%;\n}\n.styles_module_slider__8ff8ce5a::-webkit-scrollbar {\n  display: none;\n}\n.styles_module_slider__8ff8ce5a:hover, .styles_module_slider__8ff8ce5a:focus {\n  border: none !important;\n  outline: none !important;\n}\n\n.styles_module_sliderCards__8ff8ce5a {\n  display: flex;\n  flex-wrap: nowrap;\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n  display: grid;\n  grid-auto-flow: column;\n}\n\n.styles_module_itemWrap__8ff8ce5a {\n  display: flex;\n  overflow: visible;\n  scroll-snap-align: center;\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n  justify-content: center;\n  align-items: center;\n}\n\n.styles_module_item__8ff8ce5a {\n  cursor: pointer;\n  overflow: visible;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 1px solid var(--color-main-200);\n  border-radius: 15px;\n  width: 76px;\n  height: 76px;\n  color: var(--color-main-200);\n  background-color: var(--color-main-0);\n}\n.styles_module_item__8ff8ce5a span {\n  pointer-events: none;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n\n.styles_module_active__8ff8ce5a {\n  background-color: var(--color-accent-500);\n  border: 1px solid transparent;\n  transform: scaleY(1.2);\n  transition: all 0.1s ease;\n}\n.styles_module_active__8ff8ce5a span {\n  color: var(--color-main-0);\n}\n\n.styles_module_itemCaption__8ff8ce5a {\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  margin-top: 20px;\n}\n.styles_module_itemCaption__8ff8ce5a span {\n  font-weight: 200;\n  font-size: 17px;\n}\n\n.styles_module_arrowButton__8ff8ce5a {\n  z-index: 2;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  position: absolute;\n  margin-top: 36px;\n}\n\n.styles_module_arrowLeft__8ff8ce5a {\n  left: -75px;\n}\n\n.styles_module_rightArrow__8ff8ce5a {\n  right: -75px;\n}";
var modules_efc4e723$9 = {"sliderContainer":"styles_module_sliderContainer__8ff8ce5a","sliderWrap":"styles_module_sliderWrap__8ff8ce5a","leftGradient":"styles_module_leftGradient__8ff8ce5a","rightGradient":"styles_module_rightGradient__8ff8ce5a","slider":"styles_module_slider__8ff8ce5a","sliderCards":"styles_module_sliderCards__8ff8ce5a","itemWrap":"styles_module_itemWrap__8ff8ce5a","item":"styles_module_item__8ff8ce5a","active":"styles_module_active__8ff8ce5a","itemCaption":"styles_module_itemCaption__8ff8ce5a","arrowButton":"styles_module_arrowButton__8ff8ce5a","arrowLeft":"styles_module_arrowLeft__8ff8ce5a","rightArrow":"styles_module_rightArrow__8ff8ce5a"};
n(css$9,{});
...
var ChipsSlider = function (props) {
    ...
    //
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$9.sliderContainer, " ").concat(props.containerClassName), ref: sliderContainerRef, tabIndex: 0, onFocus: function () {
        ...
        React__default["default"].createElement(ArrowButton, { ref: arrowLeftRef, className: "".concat(modules_efc4e723$9.arrowLeft, " ").concat(modules_efc4e723$9.arrowButton, " ").concat(props.arrowsClassName), direction: "left", onMouseUp: goPreviousCard, disabled: activeIndex === 0, style: {
                pointerEvents: isArrowButtonDisabled ? "none" : "auto",
            } }),
        React__default["default"].createElement(ArrowButton, { ref: arrowRightRef, className: "".concat(modules_efc4e723$9.rightArrow, " ").concat(modules_efc4e723$9.arrowButton, " ").concat(props.arrowsClassName), direction: "right", onMouseUp: goToNextCard, disabled: activeIndex === props.items.length - 1, style: {
                pointerEvents: isArrowButtonDisabled ? "none" : "auto",
            } }),
        React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$9.sliderWrap), ref: sliderViewRef },
            !props.hideOverlayGradients ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$9.leftGradient, " ").concat(props.overlayGradientsClassName), ref: overlayGradientLeftRef }),
                React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$9.rightGradient, " ").concat(props.overlayGradientsClassName), ref: overlayGradientRightRef }))) : null,
            ...
            React__default["default"].createElement("div", { className: modules_efc4e723$9.slider, ref: sliderRef, id: "small-cards-slider", onFocus: function () {
                ...
                React__default["default"].createElement("div", { className: modules_efc4e723$9.sliderCards, style: {
                    ...
                    return (React__default["default"].createElement("div", { key: index, className: "".concat(modules_efc4e723$9.itemWrap), ref: function (el) { return (sliderItemWrapRefs.current[index] = el); }, style: {
                            height: "".concat(props.cardHeight + props.spaceBetween, "px"),
                            width: "".concat(props.cardWidth + props.spaceBetween, "px"),
                        } },
                        React__default["default"].createElement("div", { "data-index": index, className: "".concat(modules_efc4e723$9.item), ref: function (el) { return (sliderItemRefs.current[index] = el); }, onClick: function () { return handleCardClick(index); }, style: {
        ...
        props.showCaption ? (React__default["default"].createElement("div", { className: modules_efc4e723$9.itemCaption },
...
var SliderWrapper = function (props) {
    ...
    //
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$8.sliderContainer, " ").concat(props.containterClassName), ref: sliderContainerRef, tabIndex: 1, onFocus: function () {
            setIsSliderWrapFocused(true);
        }, onBlur: function () {
            setIsSliderWrapFocused(false);
        }, onWheel: function () {
        ...
        !props.hideArrows ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(ArrowButton, { ref: arrowLeftRef, className: "".concat(modules_efc4e723$8.arrowButton, " ").concat(props.arrowsClassName), disabled: activeIndex === 0, onMouseUp: goPreviousCard, style: {
                    left: "".concat(-arrowsOffsetRatio, "px"),
                    pointerEvents: isArrowButtonDisabled ? "none" : "auto",
                } }),
            React__default["default"].createElement(ArrowButton, { ref: arrowRightRef, direction: "right", className: "".concat(modules_efc4e723$8.arrowButton, " ").concat(props.arrowsClassName), disabled: activeIndex === paginationAmount - 1, onMouseUp: goToNextCard, style: {
                    right: "".concat(-arrowsOffsetRatio, "px"),
                    pointerEvents: isArrowButtonDisabled ? "none" : "auto",
                } }))) : null,
        React__default["default"].createElement("div", { className: modules_efc4e723$8.slider, ref: sliderRef, onFocus: function () {
                setIsSliderFocused(true);
            }, onBlur: function () {
                setIsSliderFocused(false);
            }, tabIndex: 1 },
            React__default["default"].createElement("div", { className: modules_efc4e723$8.sliderCards }, React__default["default"].Children.map(props.children, function (child, index) {
                return (React__default["default"].createElement("div", { ref: function (el) { return (sliderRefChildren.current[index] = el); }, className: modules_efc4e723$8.cardWrap, style: {
                        flex: "1 0 ".concat((viewWidth - props.spaceBetween * (cardsToShow - 1) - 2) /
                            cardsToShow, "px"),
                        marginRight: "".concat(props.spaceBetween, "px"),
                    } }, child));
            }))),
        React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$8.paginationWrap, " ").concat(props.paginationClassName) },
            React__default["default"].createElement(DotPagination, { activeIndex: activeIndex, totalAmount: paginationAmount, className: modules_efc4e723$8.pagination }))));
};
...
var css$6 = ".styles_module_divider__86777761 {\n  position: relative;\n  z-index: 10;\n  display: block;\n  width: 100%;\n  height: 1px;\n  background-color: var(--color-main-500);\n  opacity: 0.12;\n}";
var modules_efc4e723$6 = {"divider":"styles_module_divider__86777761"};
n(css$6,{});

var Divider = function (props) {
    return React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$6.divider, " ").concat(props.className) });
};
...
var BottomSheet = React__default["default"].forwardRef(function (props, ref) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement("aside", { role: "dialog", tabIndex: -1, "aria-modal": true, "aria-hidden": false, ref: modalWrapRef, className: "".concat(modules_efc4e723$5.modalWrap), style: __assign({}, props.style) },
            React__default["default"].createElement("section", { ref: bottomSheetRef, className: "".concat(modules_efc4e723$5.bottomSheetWrap) },
                ...
                React__default["default"].createElement("div", { className: modules_efc4e723$5.contentWrapper }, props.children)),
            React__default["default"].createElement("div", { ref: backgroundRef, className: modules_efc4e723$5.background }))));
});
...
var css$3 = ".styles_module_modalWrap__5c624591 {\n  position: fixed;\n  z-index: 999;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-image: radial-gradient(circle, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0) 10%);\n  pointer-events: none;\n  opacity: 0;\n}\n\n.styles_module_contentWrapper__5c624591 {\n  width: 100%;\n  margin: 0 auto;\n}\n\n.styles_module_popup__5c624591 {\n  position: absolute;\n  z-index: 2;\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  top: 50%;\n  left: 50%;\n  min-height: 200px;\n  max-height: calc(100% - 40px);\n  padding: 30px;\n  border-radius: 15px;\n  opacity: 0;\n  transform: translate(-50%, -50%) scale(0.95);\n  background-color: var(--color-main-0);\n  transition: opacity 0.3s ease, transform 0.3s ease;\n}\n.styles_module_popup__5c624591::-webkit-scrollbar {\n  width: 0;\n}\n.styles_module_popup_maxLayout__5c624591 {\n  width: calc(100% - 40px);\n  padding: 90px 30px 90px;\n  max-width: 660px;\n}\n.styles_module_popup_maxLayout__5c624591 .styles_module_contentWrapper__5c624591 {\n  max-width: 440px;\n}\n@media screen and (max-width: 620px) {\n  .styles_module_popup__5c624591 {\n    top: 0;\n    left: 0;\n    transform: none;\n    max-width: none;\n    width: 100%;\n    height: 100%;\n    padding: 30px 30px 80px;\n    max-height: none;\n    border-radius: 0;\n    background-color: var(--color-main-0);\n  }\n}\n.styles_module_popup_show__5c624591 {\n  transform: translate(-50%, -50%) scale(1);\n  opacity: 1;\n}\n@media screen and (max-width: 620px) {\n  .styles_module_popup_show__5c624591 {\n    transform: translate(0, 0) scale(1);\n  }\n}\n\n.styles_module_gradients__5c624591 {\n  z-index: 1;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%) scale(0.1);\n  width: 300px;\n  height: 300px;\n  opacity: 0;\n}\n\n.styles_module_gradient1__5c624591 {\n  position: absolute;\n  width: 1200px;\n  height: 1400px;\n  top: 50%;\n  left: 50%;\n  opacity: 0.8;\n  transform: translate(-50%, -50%) scale(1.2) rotate(45deg);\n  background-image: var(--gradient-peach);\n}\n\n.styles_module_gradient2__5c624591 {\n  position: absolute;\n  width: 700px;\n  height: 1000px;\n  top: 10%;\n  left: 90%;\n  opacity: 0.8;\n  transform: translate(-50%, -50%) scale(1.2) rotate(33deg);\n  background-image: var(--gradient-velvet);\n}";
var modules_efc4e723$3 = {"modalWrap":"styles_module_modalWrap__5c624591","contentWrapper":"styles_module_contentWrapper__5c624591","popup":"styles_module_popup__5c624591","popup_maxLayout":"styles_module_popup_maxLayout__5c624591","popup_show":"styles_module_popup_show__5c624591","gradients":"styles_module_gradients__5c624591","gradient1":"styles_module_gradient1__5c624591","gradient2":"styles_module_gradient2__5c624591"};
n(css$3,{});
...
var Popup = React__default["default"].forwardRef(function (props, ref) {
    ...
    React__default["default"].useEffect(function () {
        if (props.isOpen) {
            ...
            gsapWithCSS.to(modalWrapRef.current, {
                ...
                onComplete: function () {
                    var _a;
                    (_a = popupRef.current) === null || _a === void 0 ? void 0 : _a.classList.add(modules_efc4e723$3.popup_show);
                },
            });
            ...
            gsapWithCSS.to(modalWrapRef.current, {
                ...
                onStart: function () {
                    var _a;
                    (_a = popupRef.current) === null || _a === void 0 ? void 0 : _a.classList.remove(modules_efc4e723$3.popup_show);
                },
            });
            gsapWithCSS.to(gradients.current, {
                opacity: 0,
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement("aside", { role: "dialog", tabIndex: -1, "aria-modal": true, "aria-hidden": false, ref: modalWrapRef, className: "".concat(modules_efc4e723$3.modalWrap), style: __assign({}, props.style) },
            React__default["default"].createElement("section", { ref: popupRef, className: "".concat(modules_efc4e723$3.popup, " ").concat(!props.customWidth && props.customWidth === 0
                    ? modules_efc4e723$3.popup_maxLayout
                ...
                React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$3.contentWrapper, " ").concat(modules_efc4e723$3.popupContentClassName) }, props.children)),
            React__default["default"].createElement("div", { className: modules_efc4e723$3.gradients, ref: gradients },
                React__default["default"].createElement("div", { className: modules_efc4e723$3.gradient1 }),
                React__default["default"].createElement("div", { className: modules_efc4e723$3.gradient2 })))));
});
Popup.defaultProps = {
    title: "",
    customWidth: 0,
...
var css$2 = ".styles_module_wrap__534786f8 {\n  display: flex;\n  margin: 40px -30px -30px;\n  border-top: 1px solid var(--color-main-50);\n}\n\n.styles_module_button__534786f8 {\n  cursor: pointer;\n  flex: 1;\n  color: var(--color-main-500);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 30px;\n  border: none;\n  outline: none;\n  background: none;\n  transition: background 0.15s ease;\n  border-left: 1px solid var(--color-main-50);\n}\n.styles_module_button__534786f8:first-child {\n  border-left: none;\n}\n.styles_module_button__534786f8:hover, .styles_module_button__534786f8:focus-visible {\n  background-color: var(--color-main-50);\n}\n\n.styles_module_content__534786f8 {\n  display: flex;\n  align-items: center;\n}\n\n.styles_module_icon__534786f8 {\n  margin-right: 10px;\n  flex: 1 0 auto;\n}";
var modules_efc4e723$2 = {"wrap":"styles_module_wrap__534786f8","button":"styles_module_button__534786f8","content":"styles_module_content__534786f8","icon":"styles_module_icon__534786f8"};
n(css$2,{});

var ModalButtons = function (props) {
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$2.wrap, " ").concat(props.className) }, props.items.map(function (item, index) {
        return (React__default["default"].createElement("button", { className: modules_efc4e723$2.button, key: index, onClick: item.onClick },
            React__default["default"].createElement("div", { className: modules_efc4e723$2.content },
                item.icon ? (React__default["default"].createElement(Icon, { className: modules_efc4e723$2.icon, name: item.icon })) : null,
...
var css$1 = ".styles_module_accordion__b248d1dc {\n  display: flex;\n  flex-direction: column;\n  border-top: 1px solid var(--color-main-500);\n}\n.styles_module_accordion__b248d1dc:last-child {\n  border-bottom: 1px solid var(--color-main-500);\n}\n\n.styles_module_header__b248d1dc {\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  padding: 26px 0;\n}\n.styles_module_header__b248d1dc:hover, .styles_module_header__b248d1dc:focus {\n  outline: none;\n}\n.styles_module_header__b248d1dc:hover .styles_module_arrowButton__b248d1dc, .styles_module_header__b248d1dc:focus .styles_module_arrowButton__b248d1dc {\n  border: 1px solid var(--color-main-200);\n}\n.styles_module_header__b248d1dc:hover .styles_module_arrowButton__b248d1dc svg, .styles_module_header__b248d1dc:focus .styles_module_arrowButton__b248d1dc svg {\n  stroke: var(--color-main-200);\n}\n\n.styles_module_title__b248d1dc {\n  font-family: \"ABCMArfa\", sans-serif;\n  font-weight: 300;\n  font-size: 24px;\n  line-height: 130%;\n  width: 100%;\n  margin-bottom: 0;\n  margin-right: 32px;\n}\n@media only screen and (max-width: 620px) {\n  .styles_module_title__b248d1dc {\n    font-weight: 500;\n    font-size: 17px;\n  }\n}\n\n.styles_module_arrowButton__b248d1dc {\n  position: relative;\n  flex: 1 0 40px;\n  height: 40px;\n  border-radius: 100px;\n  border: 1px solid var(--color-main-500);\n  transition: background 0.1s ease, transform 0.3s ease;\n}\n.styles_module_arrowButton__b248d1dc svg {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  width: 19px;\n  height: 10px;\n  stroke: var(--color-main-500);\n  stroke-width: 1px;\n  transition: all 0.1s ease;\n}\n\n.styles_module_content__b248d1dc {\n  overflow: hidden;\n  max-height: 0;\n  transition: max-height 0.4s ease;\n}\n\n.styles_module_contentWrap__b248d1dc {\n  padding-bottom: 32px;\n  padding-right: 52px;\n  transition: opacity 0.4s ease;\n}\n@media only screen and (max-width: 620px) {\n  .styles_module_contentWrap__b248d1dc {\n    padding-right: 0;\n  }\n}\n\n.styles_module_open__b248d1dc .styles_module_content__b248d1dc {\n  will-change: max-height;\n  max-height: 1000px;\n  transition: max-height 0.8s ease;\n}\n.styles_module_open__b248d1dc .styles_module_arrowButton__b248d1dc {\n  transform: rotate(180deg);\n}";
var modules_efc4e723$1 = {"accordion":"styles_module_accordion__b248d1dc","header":"styles_module_header__b248d1dc","arrowButton":"styles_module_arrowButton__b248d1dc","title":"styles_module_title__b248d1dc","content":"styles_module_content__b248d1dc","contentWrap":"styles_module_contentWrap__b248d1dc","open":"styles_module_open__b248d1dc"};
n(css$1,{});
...
var AccordionItem = function (props) {
    ...
    return (React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$1.accordion, " ").concat(isOpen ? modules_efc4e723$1.open : "") },
        React__default["default"].createElement("div", { className: modules_efc4e723$1.header, onClick: haandleOpen, tabIndex: 0, onKeyDown: handleOpenOnEnter },
            React__default["default"].createElement("h3", { className: modules_efc4e723$1.title }, props.title),
            React__default["default"].createElement("div", { className: modules_efc4e723$1.arrowButton },
        ...
        React__default["default"].createElement("div", { className: "".concat(modules_efc4e723$1.content) },
            React__default["default"].createElement("div", { className: modules_efc4e723$1.contentWrap }, props.content))));
};
AccordionItem.defaultProps = {
    className: "",
};

var css = ".styles_module_wrap__6794ee91 {\n  display: flex;\n  flex-direction: column;\n}";
var modules_efc4e723 = {"wrap":"styles_module_wrap__6794ee91"};
n(css,{});

var Accordion = function (props) {
    return (React__default["default"].createElement("div", { className: "".concat(props.className, " ").concat(modules_efc4e723.wrap, "\n      }") }, props.items.map(function (item, index) {
